...
#
# Commands:
#   hubot image|show me <query> - The Original. Queries Google Images for <query> and returns a random top result.
...
module.exports = (robot) ->
  robot.respond /(image|show)( me)? (.*)/i, (msg) ->
    isBored = Math.random() > 0.5
    if msg.message.text.match(/smartosc/i) and isBored
      msg.send 'Why keep asking me about SmartOSC? I\'m getting bored...'
    else
